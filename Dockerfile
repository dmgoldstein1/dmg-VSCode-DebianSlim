...
# Generated by Copilot (GPT-4), 2025-08-25
# This Dockerfile CMD launches the VS Code tunnel server on container start.
# If not already authenticated, it will print the one-time auth code and tunnel link to stdout (docker logs).
